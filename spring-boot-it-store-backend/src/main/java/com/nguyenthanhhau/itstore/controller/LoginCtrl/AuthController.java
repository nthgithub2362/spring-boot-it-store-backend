package com.nguyenthanhhau.itstore.controller.LoginCtrl;
...
import com.nguyenthanhhau.itstore.entity.ERole;
import com.nguyenthanhhau.itstore.entity.Role;
import com.nguyenthanhhau.itstore.entity.User;
import com.nguyenthanhhau.itstore.payload.request.LoginRequest;
import com.nguyenthanhhau.itstore.payload.request.SignupRequest;
import com.nguyenthanhhau.itstore.payload.response.JwtResponse;
import com.nguyenthanhhau.itstore.payload.response.MessageResponse;
import com.nguyenthanhhau.itstore.repository.RoleRepository;
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
		if (userRepository.existsByUsername(signUpRequest.getUsername())) {
			return ResponseEntity
					.badRequest()
					.body(new MessageResponse("Error: Tên đã tồn tại!"));
		}
